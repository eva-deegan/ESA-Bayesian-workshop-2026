...
jm = jags.model("Project_6_Model_KEY_wateruse.R", data = dat, 
                inits = inits, n.chains = 3)

# Initial application of coda.samples and monitor quantities of interest
n.iter = 10000
coda = coda.samples(jm,variable.names=c("deviance","b","b0","mu.b","mu.b0",
                                        "sig","sig.b","sig.b0"), 
                    n.iter = n.iter)
...
n.iter = 5000
coda.rep = coda.samples(jm,variable.names = c("Yrep"),
                         n.iter = n.iter)
